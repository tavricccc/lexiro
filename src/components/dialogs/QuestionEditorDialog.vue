...
const props = defineProps<{
  ...
  saveHandler?: (question: MultipleChoiceQuestion) => boolean | Promise<boolean>
}>()
...
async function save(): Promise<boolean> {
  ...
  if (props.saveHandler) {
    saved = await props.saveHandler(normalized)
  }
    ...
    saved = Boolean(libraryStore.importQuestions([normalized]))
  }
  if (!saved) {
    error.value = t('vocabulary.questionSourceInvalid')
    return false
