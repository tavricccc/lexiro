...
const selected = computed(() => props.selectable && props.selectedId === props.folder.id)
</script>
...
<template>
  <div>
    <div
      ...
      :class="!selectable ? 'text-ink-400 dark:text-ink-500' : selected ? 'bg-accent-primary/10 text-accent-primary' : 'text-ink-700 hover:bg-ink-100/80 dark:text-ink-200 dark:hover:bg-ink-800/80'"
