 ...
 */
export function questionPromptIssue(
  _questionStyle: QuestionStyle,
  prompt: string,
): QuestionPromptIssue {
 ...
 */
export function passageBlankIssue(
...
export function parseAnswerIndex(
  value: string,
  optionCount: number,
): number | null {
...
export function parseQuestionDifficulty(
  value: string,
