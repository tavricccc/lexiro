...
【生成規則】
- 只處理使用者提供的單字和片語，不要自行新增、刪除或合併。
- 為每個單字提供常見且精確的詞性，以及繁體中文意思。
- 不要生成例句、選擇題、閱讀題或任何額外欄位。
...
{
  "items": [
    { "word": "單字", "pos": "詞性", "meaning": "繁體中文意思" }
  ]
}
- items 數量必須與使用者提供的單字／片語數量相同，不能遺漏、重複或自行新增。
- 每筆 item 必須包含 word、pos、meaning 三個欄位，所有 key 與字串使用雙引號。
