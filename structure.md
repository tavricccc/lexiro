...
- `packages/ai-contract` v1.6.0 — shared account/usage page types, opaque next cursors, and reported/pending/unavailable usage states; no private billing formula.
