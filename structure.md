...
- `packages/ai-contract` v1.7.0 — shared account/usage page types, opaque next cursors, usage states, and photo batch limits (10 images, 1.5 MB per image, 20,000,009-byte base64 body); no private billing formula.
