/**
 * Google's own mark, for the one button that starts Google's sign-in.
 *
 * It is not in `Icons` because that table is a set of concepts drawn in one
 * line weight, and this is a specific company's four-colour logo. It appears
 * exactly once, on the control that hands the reader to Google.
 */
