      ...
      <section className="rounded-2xl bg-muted/70 px-5 py-9 text-center sm:px-8 sm:py-11">
        ...
        {typing && !revealed ? (
          ...
          >
            ...
            {item.example && (
              <p className="mx-auto mt-4 max-w-xl type-lead">{item.example}</p>
            )}
            <div className="mx-auto mt-8 grid max-w-sm grid-cols-2 gap-2">
              ...
              <Button size="lg" disabled={busy} onClick={() => onRate("good")}>
          ...
          <Button className="mt-9" size="lg" onClick={onReveal}>
            {t("practice.reveal")}
          </Button>
        )}
      </section>
